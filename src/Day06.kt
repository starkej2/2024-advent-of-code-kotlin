...
private fun part2(inputLines: List<String>): Int {
    ...
    val visitedPositions = getPositionsVisitedByGuard(originalMap)

//    visitedPositions.forEach { position ->
//        val loopTestMap = originalMap.copy(newObstacleLocation = position)
//
//
//    }
    return -1
...
private fun runGuard(
    ...
    var map = initialMap
    initialMap.guardPosition?.let { onNewPositionVisited(it) }
//    println("\ninitial map state:")
//    map.print()
